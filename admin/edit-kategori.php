...
$data = mysqli_query($conn,"SELECT * FROM ktgr_wisata where id_kategori='$id'");
...
if (isset($_POST['edit'])) {
	...
	$edit = mysqli_query($conn,"UPDATE ktgr_wisata set nm_kategori='$ktgr' where id_kategori='$id'");
	if($edit){
