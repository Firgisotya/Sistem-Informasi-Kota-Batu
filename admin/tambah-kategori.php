...
<head>
    ...
    <title>SISBAT | Tambah Kategori</title>
...
if(isset($_POST['tambah'])){
	...
	$ktgr = $_POST['kategori'];
	$cek = mysqli_query($conn,"SELECT * FROM ktgr_wisata where nm_kategori='$ktgr'");
	if(mysqli_num_rows($cek) > 0){
		...
		$save = mysqli_query($conn,"INSERT INTO ktgr_wisata (nm_kategori) VALUES ('$ktgr')");
		if($save){
