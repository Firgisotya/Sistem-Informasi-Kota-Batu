...
<head>
    ...
    <title>SISBAT | Histori Pesan Hotel</title>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        if ($txtcari == !"") {
                            ...
                            $a = $_SESSION['id'];
                            $query = mysqli_query($conn, "SELECT * FROM transaksi_hotel, user, hotel WHERE transaksi_hotel.id_user = user.id AND transaksi_hotel.kd_hotel = hotel.kd_hotel AND user.id='$a' ORDER BY transaksi_hotel.kd_transaksi DESC");
                        }
