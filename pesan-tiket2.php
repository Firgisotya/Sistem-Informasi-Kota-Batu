<?php 
	...
	$query = mysqli_query($conn, "SELECT * FROM transaksi_wisata, user, wisata WHERE transaksi_wisata.id_user = user.id AND transaksi_wisata.kd_wisata = wisata.kd_wisata AND kd_transaksi = '$kd_trs'");
...
if(isset($_POST['hapus'])){
    ...
    $hapus = mysqli_query($conn, "DELETE FROM transaksi_wisata where kd_transaksi = '$kd_trans'");
    if($hapus){
        ?>
<Script>
alert('Data Pembayaran Berhasil Dibatalkan');
document.location = "pesan-tiket.php?kd=<?= $t['kd_wisata']; ?>";
</Script>
<?php
    }
}
if(isset($_POST['bayar'])){
    ...
    $simpan = mysqli_query($conn, "UPDATE transaksi_wisata SET bukti = '$nama_file' WHERE transaksi_wisata.kd_transaksi = '$kd_trans'");
    if ($simpan) {
        ?>
<Script>
alert('Pembayaran Berhasil');
document.location = "histori-pesan-tiket.php";
</Script>
<?php
    }
}
